...
class RentalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rental" do
    assert_difference('Rental.count') do
      post rentals_url, params: { rental: { date: @rental.date, movie_id: @rental.movie_id } }
    end
  ...
  test "should update rental" do
    patch rental_url(@rental), params: { rental: { date: @rental.date, movie_id: @rental.movie_id } }
